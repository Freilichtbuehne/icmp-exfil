...
from channel import ICMP_Channel_Client, ICMP_Channel_Server
...
data_size = icmp.data_size(input_file_content)
logger.debug(f"Sending {data_size} bytes")

# Step 3: Send size of data
data_size = data_size.to_bytes(icmp.block_size, "big")
icmp.send_data(data_size, args.receiver, args.delay)
